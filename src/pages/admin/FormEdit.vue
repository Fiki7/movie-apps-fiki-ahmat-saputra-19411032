        ...
        <div class="row">
          ...
          <div class="col">
            <q-banner inline-actions class="text-b;ue-grey-12">
              <div class="text-h6">Edit Anime</div>
              <div>Input Data Anime</div>
            </q-banner>
          </div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    getData () {
      this.$axios.get(`anime/getbyid/${this.$route.params.id}`)
        .then(res => {
          if (res.data.sukses) {
    ...
    onSubmit () {
      ...
      this.$axios.put(`anime/edit/${this.$route.params.id}`, formData)
        .then(res => {
          if (res.data.sukses) {
